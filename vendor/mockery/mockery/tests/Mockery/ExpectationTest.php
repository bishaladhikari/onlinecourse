...
class ExpectationTest extends MockeryTestCase
{
    ...
    public function testAnExampleWithSomeExpectationAmends()
    {
        ...
        $service->shouldReceive('login')->with('_user', 'pass')->once()->andReturn(true);
        ...
        $this->assertTrue($service->login('_user', 'pass'));
    ...
    public function testAnExampleWithSomeExpectationAmendsOnCallCounts_PHPUnitTest()
    {
        ...
        $service->expects($this->once())->method('login')->with('_user', 'pass')->will($this->returnValue(true));
