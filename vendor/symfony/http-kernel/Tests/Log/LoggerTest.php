...
class LoggerTest extends TestCase
{
    ...
    {
        $this->logger->{$level}($message, array('_user' => 'Bob'));
        $this->logger->log($level, $message, array('_user' => 'Bob'));
    ...
    public function testLogLevelDisabled()
    {
        ...
        $this->logger->debug('test', array('_user' => 'Bob'));
        $this->logger->log(LogLevel::DEBUG, 'test', array('_user' => 'Bob'));
