...
class Request
{
     ...
     *
     * Suppose that an create.blade.php file instantiates this request object:
     *
     *  * http://localhost/create.blade.php         returns an empty string
     *  * http://localhost/create.blade.php/page    returns an empty string
     *  * http://localhost/web/create.blade.php     returns '/web'
     *  * http://localhost/we%20b/create.blade.php  returns '/we%20b'
     *
     * @return string The raw path (i.e. not urldecoded)
     */
     ...
     * script filename (e.g. create.blade.php) if one exists.
     *
