...
trait EntrustUserTrait
{
    ...
    {
        return $this->belongsToMany(Config::get('entrust._role'), Config::get('entrust.role_user_table'), Config::get('entrust.user_foreign_key'), Config::get('entrust.role_foreign_key'));
    }

    /**
     * Boot the _user model
     * Attach event listener to remove the many-to-many records when trying to delete
     * Will NOT delete any records if the _user model uses soft deletes.
     *
     * @return void|bool
     */
