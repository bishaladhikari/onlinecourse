...
<script>
    export default {
        ...
        methods: {
            fetchSections(){
                return axios.get('/api/author/section?course_id='+this.course).then(function (response) {
...
//                    this.editing_question=false
            ...
            fetchSection(id){
                return axios.get('/api/author/section?course_id='+id).then(function (response) {
