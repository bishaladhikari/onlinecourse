...
class RequestTest extends TestCase
{
    ...
    public function testGetUri()
    {
        ...
        $server['REQUEST_URI'] = '/create.blade.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/create.blade.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/create.blade.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/create.blade.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/create.blade.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/create.blade.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/create.blade.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide create.blade.php)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ create.blade.php [QSA,L]
        ...
        $server['SCRIPT_NAME'] = '/create.blade.php';
        $server['PHP_SELF'] = '/create.blade.php';
        $server['SCRIPT_FILENAME'] = '/some/where/create.blade.php';
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/create.blade.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/create.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/create.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/create.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/create.blade.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/create.blade.php';
        $server['ORIG_SCRIPT_NAME'] = '/create.blade.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                ...
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/fruit/create.blade.php',
                    'SCRIPT_NAME' => '/fruit/create.blade.php',
                    'PHP_SELF' => '/fruit/create.blade.php',
                ),
                '/fruit',
            ...
            array(
                '/fruit/strawberry/1234index.php/blah',
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/create.blade.php',
                    'SCRIPT_NAME' => '/create.blade.php',
                    'PHP_SELF' => '/create.blade.php',
                ),
                '',
                '/fruit/strawberry/1234index.php/blah',
            ),
