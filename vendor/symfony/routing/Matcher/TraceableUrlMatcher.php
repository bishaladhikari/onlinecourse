        ...
        foreach ($routes as $name => $route) {
            ...
            if ($requiredSchemes = $route->getSchemes()) {
                ...
                if (!$route->hasScheme($scheme)) {
                    $this->addTrace(sprintf('Scheme "%s" does not match any of the required schemes (%s); the _user will be redirected to first required scheme', $scheme, implode(', ', $requiredSchemes)), self::ROUTE_ALMOST_MATCHES, $name, $route);
