...
let iconClassName;
let editIconClassName;
$('.demo').iconpicker();
$('.editIcon').iconpicker();
// $('.demo').on('iconpickerSelected', function (e) {
...
$('.demo').on('iconpickerSelected', function(e) {
    ...
    iconClassName=e.iconpickerItem.title.toString().split('.')[1];
});
$('.editIcon').on('iconpickerSelected', function(e) {

    editIconClassName=e.iconpickerItem.title.toString().split('.')[1];
});
let body=$('body');
