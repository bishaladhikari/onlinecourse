...
trait EntrustRoleTrait
{
    ...
    /**
     * Many-to-Many relations with the _user model.
     *
    ...
    /**
     * Boot the _role model
     * Attach event listener to remove the many-to-many records when trying to delete
     * Will NOT delete any records if the _role model uses soft deletes.
     *
     * @return void|bool
     */
    public static function boot()
    {
        ...
        static::deleting(function($role) {
            if (!method_exists(Config::get('entrust._role'), 'bootSoftDeletes')) {
                $role->users()->sync([]);
                $role->perms()->sync([]);
            }
    ...
    /**
     * Checks if the _role has a permission by its name.
     *
    ...
    /**
     * Attach permission to current _role.
     *
    ...
    /**
     * Detach permission from current _role.
     *
     * @param object|array $permission
     *
     * @return void
    ...
    /**
     * Attach multiple permissions to current _role.
     *
    ...
    /**
     * Detach multiple permissions from current _role
     *
     * @param mixed $permissions
     *
     * @return void
