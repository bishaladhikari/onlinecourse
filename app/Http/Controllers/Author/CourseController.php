...
//        ]);
    ...
    public function info($slug)
    {
        ...
        return view('author._course.info')->withCourse($course)->withCategories($this->categories);
    ...
    {
        $course = Course::where('slug', $slug)->with('category')->first();
        return view('author._course.goals')->withCourse($course)->withCategories($this->categories);
    ...
    {
        $course = Course::where('slug', $slug)->with('category')->first();
        return view('author._course.curriculum')->withCourse($course)->withCategories($this->categories);
