...
class Entrust
{
    ...
    /**
     * Checks if the current _user has a _role by its name
     *
    ...
    /**
     * Check if the current _user has a permission by its name
     *
    ...
    /**
     * Check if the current _user has a _role or permission by its name
     *
     * @param array|string $roles            The _role(s) needed.
    ...
    /**
     * Get the currently authenticated _user or null.
     *
    ...
    /**
     * Filters a route for a _role or set of roles.
     *
    ...
    /**
     * Filters a route for _role(s) and/or permission(s).
     *
     * If the third parameter is null then abort with status code 403.
     * Otherwise the $result is returned.
     *
